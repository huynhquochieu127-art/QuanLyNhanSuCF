...
const translations = {
  en: {
    ...
    nav_employee_timesheet: "Employee Timesheets",
    nav_my_timesheet: "My Timesheet",
    nav_shift_management: "Shift Management",
    nav_payroll: "Payroll",
    desc_payroll: "Calculate and export monthly payroll",
    ...
    home_welcome_admin: "Welcome back, Administrator",
    home_welcome_manager: "Welcome back, Manager",
    home_welcome_staff: "Welcome back, Staff",
  ...
  vi: {
    ...
    nav_scheduling: "Bảng đăng ký ca làm",
    nav_timekeeping: "Chấm công",
    nav_logs: "Lịch sử hệ thống",
    nav_employee_timesheet: "Bảng Công Nhân Viên",
    nav_my_timesheet: "Bảng Công Của Tôi",
    nav_shift_management: "Quản lý Ca làm",
    nav_payroll: "Tính lương",
    desc_payroll: "Tính toán và xuất bảng lương nhân sự",
    ...
    home_welcome_admin: "Chào mừng trở lại, Quản trị viên",
    home_welcome_manager: "Chào mừng trở lại, Quản lý",
    home_welcome_staff: "Chào mừng trở lại, Nhân viên",
    ...
    desc_scheduling: "Đăng ký ca và duyệt ca làm việc",
